...
const textVariants = cva('text-muted-foreground', {
  variants: {
    variant: {
      ...
      bodySm: 'text-sm leading-7 text-muted-foreground',
      bodyBase: 'text-base leading-8 text-muted-foreground',
      metaXs:
        'uppercase text-muted-foreground text-[0.64rem] tracking-[0.18em] sm:text-[0.72rem] sm:tracking-[0.22em]',
      metaSm: 'uppercase text-muted-foreground text-[0.72rem] tracking-[0.22em]',
      metaMd: 'uppercase text-muted-foreground text-[0.72rem] tracking-[0.26em]',
    },
    italic: {
      true: 'italic',
    },
